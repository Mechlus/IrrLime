...
public:
	...
	*/
	...
	//! Sets the vertical pivot for the billboard; sets hinging vertical position
	virtual void setPivotY(f32 pivot) = 0;

	//! Gets vertical pivot
	virtual f32 getPivotY() const = 0;

	//! Sets rotation lock
	virtual void setRotLock(const core::vector3d<bool>& rots) = 0;

	//! Gets rotation lock
	virtual core::vector3d<bool> getRotLock() const = 0;
};
