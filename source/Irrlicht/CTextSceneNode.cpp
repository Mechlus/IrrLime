...
void CBillboardTextSceneNode::setPivotY(f32 pivot) {
}

f32 CBillboardTextSceneNode::getPivotY() const {
	return 0.0f;
}

void CBillboardTextSceneNode::setRotLock(const core::vector3d<bool>& rots) {
}

core::vector3d<bool> CBillboardTextSceneNode::getRotLock() const {
	return core::vector3d<bool>(false, false, false);
}
