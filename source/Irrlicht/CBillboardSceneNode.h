...
public:
	...
	virtual void setPivotY(f32 pivot) override;
	virtual f32 getPivotY() const override;
	virtual void setRotLock(const core::vector3d<bool>& rots) override;
	virtual core::vector3d<bool> getRotLock() const override;
